...
<div class="container main">
    ...
    <form action="/user/reg" method="post" class="form-controll">
        ...
        <input type="password" name="password" placeholder="Введите пароль" value="<?= $_POST['password'] ?>"><br>
        <input type="password" name="re_password" placeholder="Подтвердите пароль" value="<?= $_POST['re_password'] ?>"><br>
        <div class="error"><?= $data['message'] ?></div>
        <button class="btn" id="send">Поехали</button>
    </form>
</div>
